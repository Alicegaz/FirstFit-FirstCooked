...
base_path = "bot/sent_analysis/twittersentdnn/" 
...
path1 = base_path+"/data/twitter.pkl"
with open(path1, 'rb') as f:
        WORD2INDEX = load(f, encoding='latin1')[3]
PADDING_INDEX = WORD2INDEX[u"<PADDING>"]

from sent_analysis.twittersentdnn.param_util import load_dcnn_model_params
from sent_analysis.twittersentdnn.dcnn import DCNN

params = load_dcnn_model_params(base_path+"/models/filter_widths=8,6,,batch_size=10,,ks=20,8,,fold=1,1,,conv_layer_n=2,,ebd_dm=48,,l2_regs=1e-06,1e-06,1e-06,0.0001,,dr=0.5,0.5,,nkerns=7,12.pkl")
